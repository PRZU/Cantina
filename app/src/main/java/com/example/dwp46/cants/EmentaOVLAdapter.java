...
public class EmentaOVLAdapter extends ArrayAdapter<String> {
    private final Context context;
    private final String[] values;

    EmentaOVLAdapter(Context context, String[] values) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        String reg_ap = "almoco_OVL=\'(.*?)'";
        String reg_jp = "jantar_OVL=\'(.*?)'";
